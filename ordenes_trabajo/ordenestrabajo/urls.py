...
urlpatterns = [
    ...
    path('odts/buscarodt', views.buscar_odt, name='buscar_odt'),
    path('odts/crearodt', views.crear_odt, name='crear_odt'),
    ...
    path('odts/<int:odt_id>/imprimirodt', views.imprimir_odt, name='imprimir_odt'),
]
